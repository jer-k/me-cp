/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d2ee598b8fe1afc022472860e3b455cd)
// Runtime types generated with workerd@1.20260722.1 2025-03-10 nodejs_compat
interface __BaseEnv_Env {
	API_BASE_URL: string;
	API_SECRET_KEY: string;
	MCP_OBJECT: DurableObjectNamespace<import("./src/index").MeCP>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "MeCP";
	}
